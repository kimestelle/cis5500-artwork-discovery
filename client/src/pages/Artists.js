...
export default function Artists() {
    ...
    const funFacts = [
        {
            question: "Learn who the top 10 artists are at the MET or MOMA! Choose one below.",
            id: "topartists",
        },
        {
            question: "What's the average amount of time it takes an artist to finish a piece of a specific medium?",
            id: "timebymedium",
        },
    ];
                ...
                {funFacts.map((fact) => (
                    <Box key={fact.id} sx={boxStyle}>
                        ...
                        <TextField
                            ...
                            onChange={(e) =>
                                setAnswers((prev) => ({...prev, [fact.id]: e.target.value}))
                            }
                            onKeyDown={(e) => {
